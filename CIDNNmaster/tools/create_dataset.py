...
def main():
    ...
    GC_raw_data_path = join(dirname(realpath(dirname(__file__))), 'data', 'GC', 'Annotation')
    GC_meta_data_path = join(dirname(realpath(dirname(__file__))), 'data', 'GC_meta_data.json')
    GC_train_test_data_path = join(dirname(realpath(dirname(__file__))), 'data', 'GC.npz')
